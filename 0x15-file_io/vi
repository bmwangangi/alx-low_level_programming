...
/**
 * print_data_info - Prints the data of an ELF header.
 * @e_ident: A pointer to an array containing the ELF class.
 */
...
/**
 * print_osabi_info - Prints the OS/ABI of an ELF header.
 * @e_ident: A pointer to an array containing the ELF version.
 */
...
/**
 * print_abi_info - Prints the ABI version of an ELF header.
 * @e_ident: A pointer to an array containing the ELF ABI version.
 */
void print_abi_info(unsigned char *e_ident)
{
    printf(" ABI Version: %d\n", e_ident[EI_ABIVERSION]);
}

/**
 * print_type_info - Prints the type of an ELF header.
 * @e_type: The ELF type.
 * @e_ident: A pointer to an array containing the ELF class.
 */
...
/**
 * print_entry_info - Prints the entry point of an ELF header.
...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
    ...
    print_data_info(elf_header->e_ident);
    print_version_info(elf_header->e_ident);
    print_osabi_info(elf_header->e_ident);
    print_abi_info(elf_header->e_ident);
    print_type_info(elf_header->e_type, elf_header->e_ident);
    print_entry_info(elf_header->e_entry, elf_header->e_ident);
